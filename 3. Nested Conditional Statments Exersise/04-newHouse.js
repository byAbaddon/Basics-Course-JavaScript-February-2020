function newHouse(arg) {
  [flowers, count, budget] = [arg[0], +arg[1], +arg[2]]
  result = 0
  ...
  switch (true) {
    case flowers === 'Roses' && count > 80:
       result = count * flowersPrice.get(flowers) * 0.90  //-10%
      break;
   case flowers === 'Dahlias' && count > 90:
       result = count * flowersPrice.get(flowers) * 0.85  //-15%
     break;
    case flowers === 'Tulips' && count > 80:
      result = count * flowersPrice.get(flowers) * 0.85  //-15%
    break;
    case flowers === 'Narcissus' && count < 120:
      result = count * flowersPrice.get(flowers) * 1.15  //+15%
    break;
    case flowers === 'Gladiolus' && count < 80:
      result = count * flowersPrice.get(flowers) * 1.20  //+15%
    break;
